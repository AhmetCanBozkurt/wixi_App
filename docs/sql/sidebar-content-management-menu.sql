...
-- DB: Wixi_App_TEST
-- ÖNEMLİ: N'' prefix ile Unicode — Türkçe karakter bozulması olmaz
-- ============================================================
...
VALUES (NEWID(), @fId, @trId, N'İçerik Yönetimi', @now, 1, 0),
       (NEWID(), @fId, @enId, N'Content Management', @now, 1, 0);
...
INSERT INTO WIXI_MENU_TRANSLATIONS (Id, MenuId, LanguageId, Title, CreatedAt, IsActive, IsDeleted)
VALUES (NEWID(), @m1, @trId, N'SSS Yönetimi', @now, 1, 0),
       (NEWID(), @m1, @enId, N'FAQ Management', @now, 1, 0);
...
INSERT INTO WIXI_MENU_TRANSLATIONS (Id, MenuId, LanguageId, Title, CreatedAt, IsActive, IsDeleted)
VALUES (NEWID(), @m2, @trId, N'İletişim Gelen Kutusu', @now, 1, 0),
       (NEWID(), @m2, @enId, N'Contact Inbox', @now, 1, 0);
...
INSERT INTO WIXI_MENU_TRANSLATIONS (Id, MenuId, LanguageId, Title, CreatedAt, IsActive, IsDeleted)
VALUES (NEWID(), @m3, @trId, N'Plan Yönetimi', @now, 1, 0),
       (NEWID(), @m3, @enId, N'Plan Management', @now, 1, 0);
...
INSERT INTO WIXI_MENU_TRANSLATIONS (Id, MenuId, LanguageId, Title, CreatedAt, IsActive, IsDeleted)
VALUES (NEWID(), @m4, @trId, N'Ekip Yönetimi', @now, 1, 0),
       (NEWID(), @m4, @enId, N'Team Management', @now, 1, 0);
...
INSERT INTO WIXI_MENU_TRANSLATIONS (Id, MenuId, LanguageId, Title, CreatedAt, IsActive, IsDeleted)
VALUES (NEWID(), @m5, @trId, N'Vaka Çalışmaları', @now, 1, 0),
       (NEWID(), @m5, @enId, N'Case Studies', @now, 1, 0);
...
INSERT INTO WIXI_MENU_TRANSLATIONS (Id, MenuId, LanguageId, Title, CreatedAt, IsActive, IsDeleted)
VALUES (NEWID(), @m6, @trId, N'Yol Haritası', @now, 1, 0),
       (NEWID(), @m6, @enId, N'Roadmap', @now, 1, 0);
...
INSERT INTO WIXI_MENU_TRANSLATIONS (Id, MenuId, LanguageId, Title, CreatedAt, IsActive, IsDeleted)
VALUES (NEWID(), @m7, @trId, N'Değişiklik Günlüğü', @now, 1, 0),
       (NEWID(), @m7, @enId, N'Changelog', @now, 1, 0);
...
INSERT INTO WIXI_MENU_TRANSLATIONS (Id, MenuId, LanguageId, Title, CreatedAt, IsActive, IsDeleted)
VALUES (NEWID(), @m8, @trId, N'Yasal İçerik', @now, 1, 0),
       (NEWID(), @m8, @enId, N'Legal Content', @now, 1, 0);
