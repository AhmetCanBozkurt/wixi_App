...
{
    /// <inheritdoc />
    public partial class Faz5_Addresses : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "WIXI_EC_ADDRESSES",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WIXI_EC_ADDRESSES", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WIXI_EC_ADDRESSES_WIXI_EC_CUSTOMERS_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WIXI_EC_ADDRESSES_CustomerId",
