...
export function SeoPanel({ tenantSlug }: { tenantSlug: string }) {
  ...
  const { saveSeo } = useThemeEditor(tenantSlug);
    ...
    <div className={styles.panel}>
      ...
      <div className={styles.serpPreview}>
        <div className={styles.serpUrl}>
          {window.location.hostname}/store/.../{activePage.slug}
        </div>
      ...
      <div className={styles.propList}>
        ...
        <div className={styles.propGroup}>
          ...
          {seo.openGraphImageUrl && (
            <img src={seo.openGraphImageUrl} alt="OG Preview" style={{ width: '100%', borderRadius: '6px', marginTop: '8px', border: '1px solid #e5e7eb' }} />
          )}
        </div>
      </div>
    </div>
